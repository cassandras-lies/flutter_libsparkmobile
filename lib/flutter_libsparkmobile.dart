...
abstract final class LibSpark {
  ...
  static ffi.Pointer<FullViewKey> createFullViewKeyFromData({
    required final String privateKeyHex,
    required final int index,
  }) {
    DateTime? start;
  ...
  static LibSparkCoin? identifyAndRecoverCoinByFullViewKey({
    ...
    required final ffi.Pointer<FullViewKey> fullViewKey,
    required final Uint8List context,
    final bool isTestNet = false,
  }) {
    DateTime? start;
  ...
  static void deleteFullViewKey(ffi.Pointer<FullViewKey> fullViewKey) {
    DateTime? start;
    int? id;
